...
class DwaMissionRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DwaMissionRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DwaMissionRequest
    let len;
    let data = new DwaMissionRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DwaMissionRequest(null);
...
class DwaMissionResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DwaMissionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DwaMissionResponse
    let len;
    let data = new DwaMissionResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DwaMissionResponse(null);
...
module.exports = {
  Request: DwaMissionRequest,
  Response: DwaMissionResponse,
  md5sum() { return 'd4f8fbf2f34a6f33bd852a1c941167c4'; },
  datatype() { return 'heron_srvs/DwaMission'; }
};
